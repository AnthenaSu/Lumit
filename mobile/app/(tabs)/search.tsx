...
export default function Search() {
  ...
  const pageBg = searchActive ? '#f8f7f7' : '#fff'
          ...
          {availablePeople.length > 0 && (
            <View style={styles.sectionCard}>
              ...
              {displayedPeople.map((person, idx) => (
                <View
                  key={person.id}
                  style={[styles.historyRow, idx === displayedPeople.length - 1 && styles.historyRowLast]}
                >
          ...
          {availableItems.length > 0 && (
            <View style={styles.sectionCard}>
              ...
              {displayedItems.map((item, idx) => (
                <View
                  key={item.id}
                  style={[styles.historyRow, idx === displayedItems.length - 1 && styles.historyRowLast]}
                >
...
const styles = StyleSheet.create({
  page: { flex: 1 },
  topArea: { paddingTop: 60, paddingHorizontal: GRID_MARGIN, paddingBottom: 10 },
  browseTitle: {
  ...
  headerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, gap: 4 },
  chevronBtn: { justifyContent: 'center', alignItems: 'center', width: 32, height: 58 },
  headerTitle: {
    fontFamily: 'GCPrometheusDemo-SemiBold',
    fontSize: 50,
    color: '#000',
  ...
  contentArea: { flex: 1 },
  contentPadding: { paddingHorizontal: GRID_MARGIN, paddingTop: 8, paddingBottom: 40 },
  sectionCard: {
    backgroundColor: '#fff',
    borderRadius: 15,
    marginBottom: 16,
  ...
  sectionLabel: { fontFamily: 'GCPrometheusDemo-Regular', fontSize: 13, color: '#999999', letterSpacing: 0.8 },
  clearText: { fontFamily: 'GCPrometheusDemo-Regular', fontSize: 16, color: '#333' },
  historyRow: {
    flexDirection: 'row',
    alignItems: 'center',
    height: 80,
  ...
  historyRowLast: { borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#b3b3b3' },
  removeBtn: {
    width: 26,
    height: 26,
    borderRadius: 13,
  ...
  removeBtnText: { fontFamily: 'GCPrometheusDemo-Regular', fontSize: 14, color: '#000', lineHeight: 18 },
  showMoreRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12 },
  showMoreText: { fontFamily: 'GCPrometheusDemo-Regular', fontSize: 16, color: '#333' },
  ...
  rowAvatar: { width: 56, height: 56, borderRadius: 15, marginRight: 14 },
  rowInfo: { flex: 1 },
  rowName: { fontFamily: 'PublicSans-SemiBold', fontSize: 17, color: '#000', marginBottom: 2 },
  rowSub: { fontFamily: 'PublicSans-Regular', fontSize: 15, color: '#808080' },
  followBtn: {
    borderWidth: 1,
    borderColor: '#000',
    borderRadius: 50,
  ...
  gridContent: { paddingTop: 6, paddingBottom: 110 },
